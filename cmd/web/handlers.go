...
import (
	...
	"snippetbox.sabir.dev/internal/models"
	"snippetbox.sabir.dev/internal/validator"
)
...
func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Name), "name", "This field cannot be balnk")
	form.CheckField(validator.NotBlank(form.Email), "email", "This field cannot be balnk")
	...
	app.sessionManager.Put(r.Context(), "flash", "Your signup was successfil. Please log in")
	http.Redirect(w, r, "/user/login", http.StatusSeeOther)
}

func (app *application) userLogin(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintln(w, "Displat a HTML form for loggin in a user...")
}

func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintln(w, "Authenticate and loing the user...")
}
